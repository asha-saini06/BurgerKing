  ...
  return (
    <>
      <div className="min-h-[550px]">
        <div className="min-h-[550px] flex justify-center items-center backdrop-blur-xl px-3 py-12 sm:py-0 ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  ...
                  <br />
                  <br />
                  Join us for a royal feast where innovation meets tradition,
                  and each bite is a masterpiece. Treat yourself to the ultimate
                  flavor experience at Burger King – where satisfaction is
